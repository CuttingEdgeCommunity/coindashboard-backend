...
public class CoinMarketCapCoinInfoTestData {

  ObjectMapper mapper = new ObjectMapper();
  public JsonNode btcEthLeoJson;
  public Response btcEthLeoResponse;

  public CoinMarketCapCoinInfoTestData() throws IOException {
    File initialFile =
        new File(
            "src/test/java/com/capgemini/fs/coindashboard/apiCommunicator/coinMarketCapCommunicator/resultBuilders/testData/BtcEthLeoInfo.txt");
