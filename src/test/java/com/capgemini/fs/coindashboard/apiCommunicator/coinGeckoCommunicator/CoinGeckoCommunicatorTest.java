...
class CoinGeckoCommunicatorTest extends CoinGeckoTestBaseClass {
  ...
  public void setUp() throws IOException {
    ...
    Mockito.when(client.getCoinsMarkets(this.coins, this.vsCurr.get(1),"", "250","", "","1h,24h,7d,30d")).thenReturn(this.eurCorrectLatestR);
    Mockito.when(client.getMarketChart(this.coins.get(0), this.vsCurr.get(0),"1")).thenReturn(this.btcCorrectHistoricalR);
    Mockito.when(client.getMarketChart(this.coins.get(0), this.vsCurr.get(1),"1")).thenReturn(this.btcCorrectHistoricalR);
    Mockito.when(client.getMarketChart(this.coins.get(1), this.vsCurr.get(0),"1")).thenReturn(this.ethCorrectHistoricalR);
    Mockito.when(client.getMarketChart(this.coins.get(1), this.vsCurr.get(1),"1")).thenReturn(this.ethCorrectHistoricalR);
    Mockito.when(client.getCoinsMarkets(this.coinserr, this.vsCurr.get(0),"", "250","", "","1h,24h,7d,30d")).thenReturn(this.errorR);
    Mockito.when(client.getCoinsMarkets(this.coinserr, this.vsCurr.get(1),"", "250","", "","1h,24h,7d,30d")).thenReturn(this.errorR);
    Mockito.when(client.getMarketChart(this.coinserr.get(0), this.vsCurr.get(0), "1")).thenReturn(this.errorHistoricalR);
    Mockito.when(client.getMarketChart(this.coinserr.get(1), this.vsCurr.get(0), "1")).thenReturn(this.errorHistoricalR);
    Mockito.when(client.getMarketChart(this.coinserr.get(0), this.vsCurr.get(1), "1")).thenReturn(this.errorHistoricalR);
    Mockito.when(client.getMarketChart(this.coinserr.get(1), this.vsCurr.get(1), "1")).thenReturn(this.errorHistoricalR);
  }
