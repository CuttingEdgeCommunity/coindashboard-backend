...
class CoinMarketCapTopCoinsResultBuilderTest {
  ...
  void setResultStatusNoError() {
    ...
    this.builder.setData(data.goodResponse, new ApiCommunicatorMethodParametersDto());
  ...
  @Test
  void setCoins() {
    this.builder.setData(topCoinsTestData.top3Response, new ApiCommunicatorMethodParametersDto());
